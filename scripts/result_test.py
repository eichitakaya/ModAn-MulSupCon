...
for i in range(10):
    ...
    acl_simclr_list.append(pd.read_csv(f"../results/acl/miniRIN_HML_simCLR_1/{i+1}/acl/stats.csv").iloc[-1, :])
...
for i in range(10):
    ...
    breast_simclr_list.append(pd.read_csv(f"../results/breast/miniRIN_HML_simCLR_1/{i+1}/breast/stats.csv").iloc[-1, :])
...
for i in range(10):
    ...
    thyroid_simclr_list.append(pd.read_csv(f"../results/thyroid/miniRIN_HML_simCLR_1/{i+1}/thyroid/stats.csv").iloc[-1, :])
